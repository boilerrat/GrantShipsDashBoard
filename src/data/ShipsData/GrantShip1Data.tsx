...
const grantShip1HatData: GrantShip = hatData.grantShips.find(ship => ship.name === 'Grant Ship 1') || {};
...
const GrantShip1Data = () => {
  return (
    <div>
      ...
      <Typography variant="body2">Wearer: {grantShip1HatData.wearer}</Typography>
      <Typography variant="body2">Captain: {grantShip1HatData.captain?.wearer}</Typography>
